...
def get_args_without():
    default_args = {
        ...
        "qk_norm": True,
        "norm": 'layer',
        "text-states-dim": 1024,
        "text_states_dim": 1024,
        "text-len": 77,
        "text_len": 77,
        "text-states-dim-t5": 2048,
        ...
        "lora-ckpt": None,
        "lora_ckpt": None,
        "target-modules": ['Wqkv', 'q_proj', 'kv_proj', 'out_proj'],
        "target_modules": ['Wqkv', 'q_proj', 'kv_proj', 'out_proj'],
        "output-merge-path": None,
        "output_merge_path": None,
        ...
        "dit-weight": None,
        "dit_weight": None,
        "controlnet-weight": None,
        "controlnet_weight": None,
        "load-key": 'ema',
        "load_key": 'ema',
        "use-style-cond":False,
        ...
        "ckpt-every": 100_000,
        "ckpt_every": 100_000,
        "ckpt-latest-every": 10_000,
        "ckpt_latest_every": 10_000,
        "ckpt-every-n-epoch": 0,
        ...
        "results_dir": 'results',
        "resume": False,
        "resume-module-root": None,
        "resume_module_root": None,
        "resume-ema-root": None,
        "resume_ema_root": None,
        "strict": True,
        "index-file": None,
        "index_file": None,
        "random-flip": False,
        ...
        "reso-step": None,
        "reso_step": None,
        "random-shrink-size-cond": False,
        "random_shrink_size_cond": False,
        "merge-src-cond": False,
        ...
        "ema-decay": None,
        "ema_decay": None,
        "ema-warmup-power": None,
        "ema_warmup_power": None,
        "ema-warmup": False,
        "ema_warmup": False,
        "ema-reset-decay": False,
        ...
        "cpu-offloading": False,
        "cpu_offloading": False,
        "save-optimizer-state": False,
        "save_optimizer_state": False,
        "deepspeed-optimizer": False,
        "deepspeed_optimizer": False,
        "local_rank": None,
        "local-rank": None,
        "remote-device": 'none',
        "remote_device": 'none',
